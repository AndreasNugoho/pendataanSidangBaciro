...
// $pdf->Cell(70, 4, "Yogyakarta" , 0, 1, 'L', false);
...
// $pdf->SetXY(31, 90);
// $pdf->SetFont('Arial', '', 7);
// $pdf->Cell(52   , 4, $oleh_konfirmasi, 0, 1, 'C', false);
...
// $pdf->Cell(39   , 4, $tgl_konfirmasi, 0, 1, 'C', false);
                        ...
                        // $tempat_konfirmasi = $data_diri['tempat_konfirmasi'];
                        // $konfirmasi = explode(' ',trim($tempat_konfirmasi));
...
// var_dump($metrai);
// $pdf->Cell(39   , 4, $oleh_metrai, 0, 1, 'L', false);
...
//     $pdf->SetXY(73, 93);
//     $pdf->SetFont('Arial', '', 7);
//     $pdf->Cell(35, 4,$arr[0] , 0, 1, 'L', false);
