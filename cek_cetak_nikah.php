...
<body>
    ...
    <form action="cetak_nikah.php"method="POST">
        <?php
        ...
        ?>
            ...
            <div class="row g-2 mx-auto w-50">
            <div class="form-floating mb-3 mx-auto w-50" >
                    <input type="text" name="tmpt_tinggal_pemberkat" id="tmpt_tinggal_pemberkat" class="form-control" placeholder="tmpt_tinggal_pemberkat" readonly value="<?= $menikah["tmpt_tinggal_pemberkat"]?>">
